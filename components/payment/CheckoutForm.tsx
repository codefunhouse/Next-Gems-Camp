...
function CheckoutForm({ clientSecret, selectedCycle, paymentOption, agentCode }: CheckoutFormProps) {
  ...
  const pricing = paymentOption === "full"
      ...
      >
        ...
        {currentStep === 2 && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <button
              type="button"
              onClick={() => append({ childName: "", childDOB: "", childAge: "" })}
            ...
            {fields.length > 1 && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <p className="text-sm text-blue-800">
                  <strong>Note:</strong> You are registering {fields.length} children.
                  Total: {formatPrice(totalAmount)} ({formatPrice(amount)} per child)
                </p>
              </div>
            )}
          </div>
        ...
        {currentStep === 3 && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <h5 className="font-semibold text-sm text-gray-700 mb-2">Booking Summary</h5>
            ...
            <div className="border rounded-lg p-4">
              <h5 className="font-semibold text-sm text-gray-700 mb-3">Payment Details</h5>
              <PaymentElement
                options={{
                  layout: "tabs",
                }}
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <h5 className="font-semibold text-sm text-gray-700 mb-3">Order Summary</h5>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span>
                    {paymentOption === "full" ? "Full Program Fee" : "Deposit (25%)"}
                ...
                {paymentOption === "deposit" && (
                  <>
                    <div className="flex justify-between text-gray-600">
                      <span>Remaining Balance{numberOfChildren > 1 && ` (${numberOfChildren} children)`}</span>
            ...
            {paymentOption === "deposit" && (
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
                <p className="text-sm text-amber-800">
                  <strong>Note:</strong> After this deposit payment, an invoice for the
                  remaining {formatPrice(totalBalanceAmount)} will
                  be sent to your email. Payment must be received by{" "}
                  {formatDate(selectedCycle.balanceDueDate)}.
                </p>
              </div>
            )}
